...
>
> **Frage**: Existiert eine Teilmenge $M' \subseteq M$ mit $\sum_{a \in M'}w(a) = \sum_{a \in M\setminus M'}w(a)$, d.h. $w(M')=w(M \setminus M')$?
>
> **Kürz**: $(M, w)$
...
> **Gegeben**:
> 
> Eine endliche Menge $M$
> 
>  eine Gewichtsfunktion $w: M \rightarrow \mathbb{N_{0}}$
> 
> eine Kostenfunktion $c:M \rightarrow \mathbb{N_{0}}$
> 
> Zahlen $W, C \in \mathbb{N_{0}}$
>
> **Frage**: Existiert eine Teilmenge $M' \subseteq M$ mit $w(M') \le W$ und $c(M') \ge C$?
>
> **Kürz**: $(M, w, c, W, C)$